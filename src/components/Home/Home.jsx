        ...
        <div className='product-collection-wrapper'>
          ...
          <div className='product-col-left flex'>
            <div className='product-col-content'>
              <h2 className='sm-title sm-title-home'>Resistentes y fáciles de mantener</h2>
          ...
          <div className='product-col-right'>
            <div className='product-col-r-top flex'>
              <div className='product-col-content'>
                <h2 className='sm-title sm-title-home'>Da vida y color a tu jardín, terraza o balcón.</h2>
            ...
            <div className='product-col-r-top2 flex'>
              <div className='product-col-content'>
                <h2 className='sm-title sm-title-home'>amplia y cuidada selección de artículos y accesorios para tu jardín.</h2>
            ...
            <div className='product-col-r-top3 flex'>
              <div className='product-col-content'>
                <h2 className='sm-title sm-title-home'>Plantas, mascotas y todo para tu jardín.</h2>
